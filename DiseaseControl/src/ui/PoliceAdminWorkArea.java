 ...
 * @author yanyanchen
 */
public class PoliceAdminWorkArea extends javax.swing.JFrame {
    ...
    public PoliceAdminWorkArea(String name) {
        initComponents();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        ArrayList<User> driverList = UserDao.getAllAssociatedPoliceMan(organization);
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if(a==0){
            ...
            setVisible(false);
            new PoliceAdminWorkArea(name).setVisible(true);
        }
