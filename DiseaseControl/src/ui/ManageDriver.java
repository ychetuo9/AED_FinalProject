...
public class ManageDriver extends javax.swing.JFrame {
     ...
     */
    public ManageDriver(String name) {
        initComponents();
    ...
    public void search(String name){
        ...
        ArrayList<User> list = UserDao.searchDriver(organization, name);
    ...
    public void getAllRecords(String name){
        ...
        ArrayList<User> list = UserDao.getAllAssociatedDriver(organization);
        Iterator<User> itr = list.iterator();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 30, 100, 30));
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(a==0){
            UserDao.delete(id);
            setVisible(false);
            new ManageDriver(name).setVisible(true);
        }
