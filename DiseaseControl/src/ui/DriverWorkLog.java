 ...
 * @author yanyanchen
 */
public class DriverWorkLog extends javax.swing.JFrame {

    /**
     * Creates new form DriverWorkLog
     */
    public DriverWorkLog(String userName,String id,String request,String patientNumber,String victim,String date) {
        initComponents();
...
//        &&!date.equals("--")&&!patientNumber.equals("--")&&!victim.equals("--")&&!location.equals("--")&&!descriiption.equals("--")
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 490, -1, -1));
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        new DriverWorkArea(userName).setVisible(true);
...
//            java.util.logging.Logger.getLogger(DriverWorkLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new DriverWorkLog().setVisible(true);
//            }
//        });
//    }
