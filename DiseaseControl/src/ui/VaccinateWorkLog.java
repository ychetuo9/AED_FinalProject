 ...
 * @author yanyanchen
 */
public class VaccinateWorkLog extends javax.swing.JFrame {

    /**
     * Creates new form VaccinateWorkLog
     */
    public VaccinateWorkLog(String userName,String id,String request,String patientNumber,String victim,String date) {
        initComponents();
...
//        &&!date.equals("--")&&!patientNumber.equals("--")&&!victim.equals("--")&&!location.equals("--")&&!descriiption.equals("--")
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        new VaccinateHeadWorkArea(userName).setVisible(true);
...
//            java.util.logging.Logger.getLogger(VaccinateWorkLog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new VaccinateWorkLog().setVisible(true);
//            }
//        });
//    }
